const xn = {
    ...
    generateGradientImage: function (imageUrl, direction, startOpacity, endOpacity, callback, w, h) {
        const img = new Image();
        ...
        img.onload = function () {
            ...
            if (direction === 'vertical') {
                gradient = ctx.createLinearGradient(0, 0, 0, h ? h : img.height);
            } else if (direction === 'horizontal') {
                gradient = ctx.createLinearGradient(0, 0, w ? w : img.width, 0);
            } else {
                console.error("Unsupported direction. Use 'vertical' or 'horizontal'.");
                return;
            }
    ...
    xhr: function (url, data, cb, err, xhr_mt,method) {
        ...
        if (xhr_mt) xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
